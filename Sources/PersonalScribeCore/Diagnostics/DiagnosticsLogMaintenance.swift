...
/// `@unchecked Sendable` is safe here because the stored `FileManager`
/// is only used through documented thread-safe filesystem APIs and the
/// rest of the state is immutable value data or sendable closures.
