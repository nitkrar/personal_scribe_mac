...
public struct TranscriptRepository: Sendable, TranscriptAppending, TranscriptReading, TranscriptDeleting, TranscriptUpdating, TranscriptAudioFilenameNullifying {
