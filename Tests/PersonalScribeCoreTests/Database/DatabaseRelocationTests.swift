...
final class DatabaseRelocationTests: XCTestCase {
    ...
    func testRelocateMovesSqliteAndSidecars() throws {
        ...
        XCTAssertEqual(try Data(contentsOf: destinationDirectory.appendingPathComponent("transcripts.sqlite")), Data("sqlite".utf8))
        XCTAssertEqual(try Data(contentsOf: destinationDirectory.appendingPathComponent("transcripts.sqlite-wal")), Data("wal".utf8))
        XCTAssertEqual(try Data(contentsOf: destinationDirectory.appendingPathComponent("transcripts.sqlite-shm")), Data("shm".utf8))
    ...
    func testRelocateIsNoOpWhenSourceMissing() throws {
        ...
        XCTAssertFalse(fileManager.fileExists(atPath: baseDirectory.appendingPathComponent("db/transcripts.sqlite").path))
    }
    ...
    func testRelocateMovesOnlySidecarsPresent() throws {
        ...
        XCTAssertEqual(try Data(contentsOf: destinationDirectory.appendingPathComponent("transcripts.sqlite")), Data("sqlite".utf8))
        XCTAssertEqual(try Data(contentsOf: destinationDirectory.appendingPathComponent("transcripts.sqlite-wal")), Data("wal".utf8))
        XCTAssertFalse(fileManager.fileExists(atPath: destinationDirectory.appendingPathComponent("transcripts.sqlite-shm").path))
        XCTAssertFalse(fileManager.fileExists(atPath: sqliteURL.path))
        XCTAssertFalse(fileManager.fileExists(atPath: walURL.path))
    }
