...
echo "  After launch, the menu bar shell appears first and Parakeet CoreML (~442 MiB)"
echo "  auto-downloads / warms up in the background to:"
echo "    ~/Library/Application Support/Seshat/models/parakeet-tdt-0.6b-v2/"
echo "  The menu bar and pill show download / warmup progress while this runs."
echo ""
